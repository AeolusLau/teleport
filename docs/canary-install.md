# 闪现 / Teleport — canary 安装指南(macOS Apple Silicon)
...
1. 下载安装包(最新版):
   <https://fairyland-distribution.oss-cn-beijing.aliyuncs.com/canary/e6251e01d822b9394301aad1af5ff0a5/Teleport-0.1.0.dmg>
...
canary 阶段如遇崩溃、升级失败或其他问题,请附上版本号(关于页可见)反馈给团队。
